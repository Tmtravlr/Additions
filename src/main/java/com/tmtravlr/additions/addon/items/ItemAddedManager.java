...
public class ItemAddedManager {
	...
	public static <T extends IItemAdded> IItemAdded.Serializer<T> getSerializerFor(T itemAdded) {
	...
	public static <T extends IItemAdded> ResourceLocation getTypeFor(Class<T> itemClass) {
	...
	public static class Serializer implements JsonDeserializer<IItemAdded>, JsonSerializer<IItemAdded> {
		...
		public JsonElement serialize(IItemAdded itemAdded, Type type, JsonSerializationContext context) {
            IItemAdded.Serializer<IItemAdded> serializer = ItemAddedManager.getSerializerFor(itemAdded);
