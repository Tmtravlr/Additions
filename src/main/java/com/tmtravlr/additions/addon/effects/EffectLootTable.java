 ...
 * @date July 2017
 */
public class EffectLootTable extends Effect {
	...
	public static class Serializer extends Effect.Serializer<EffectLootTable> {
		
		public Serializer() {
			super(TYPE, EffectLootTable.class);
		}
		
		@Override
		public JsonObject serialize(EffectLootTable effect, JsonSerializationContext context) {
		...
		@Override
		public EffectLootTable deserialize(JsonObject json, JsonDeserializationContext context) {
			EffectLootTable effect = new EffectLootTable();
