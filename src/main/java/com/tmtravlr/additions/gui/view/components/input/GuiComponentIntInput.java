 ...
 * @since August 2017
 */
public class GuiComponentIntInput extends GuiTextField implements IGuiViewComponent {
	...
	public GuiComponentIntInput(String label, GuiEdit editScreen, boolean allowNegative) {
