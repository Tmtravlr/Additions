...
public class GuiColorSelect extends Gui {
    ...
    public GuiColorSelect(GuiScreen parent) {
    	this.parent = parent;
    }
    ...
    public void drawColorSelect() {
        ...
        this.parent.drawTexturedModalRect(this.x, this.y, 0, 85, this.width, this.height);
        switch (this.color) {
		case WHITE:
			this.parent.drawTexturedModalRect(this.x + 4, this.y + 4, 64, 85, 8, 8);
			break;
		case GRAY:
			this.parent.drawTexturedModalRect(this.x + 13, this.y + 4, 64, 85, 8, 8);
			break;
		case DARK_GRAY:
			this.parent.drawTexturedModalRect(this.x + 22, this.y + 4, 64, 85, 8, 8);
			break;
		case BLACK:
			this.parent.drawTexturedModalRect(this.x + 31, this.y + 4, 64, 85, 8, 8);
			break;
		case YELLOW:
			this.parent.drawTexturedModalRect(this.x + 4, this.y + 13, 64, 85, 8, 8);
			break;
		case GOLD:
			this.parent.drawTexturedModalRect(this.x + 13, this.y + 13, 64, 85, 8, 8);
			break;
		case RED:
			this.parent.drawTexturedModalRect(this.x + 22, this.y + 13, 64, 85, 8, 8);
			break;
		case DARK_RED:
			this.parent.drawTexturedModalRect(this.x + 31, this.y + 13, 64, 85, 8, 8);
			break;
		case GREEN:
			this.parent.drawTexturedModalRect(this.x + 4, this.y + 22, 64, 85, 8, 8);
			break;
		case DARK_GREEN:
			this.parent.drawTexturedModalRect(this.x + 13, this.y + 22, 64, 85, 8, 8);
			break;
		case LIGHT_PURPLE:
			this.parent.drawTexturedModalRect(this.x + 22, this.y + 22, 64, 85, 8, 8);
			break;
		case DARK_PURPLE:
			this.parent.drawTexturedModalRect(this.x + 31, this.y + 22, 64, 85, 8, 8);
			break;
		case AQUA:
			this.parent.drawTexturedModalRect(this.x + 4, this.y + 31, 64, 85, 8, 8);
			break;
		case DARK_AQUA:
			this.parent.drawTexturedModalRect(this.x + 13, this.y + 31, 64, 85, 8, 8);
			break;
		case BLUE:
			this.parent.drawTexturedModalRect(this.x + 22, this.y + 31, 64, 85, 8, 8);
			break;
		case DARK_BLUE:
			this.parent.drawTexturedModalRect(this.x + 31, this.y + 31, 64, 85, 8, 8);
			break;
		default:
			this.parent.drawTexturedModalRect(this.x + 40, this.y + 4, 64, 85, 8, 8);
			break;
        }
        
        if (this.obfuscated) {
			this.parent.drawTexturedModalRect(this.x + 51, this.y + 4, 72, 85, 9, 11);
        }
        
        if (this.bold) {
			this.parent.drawTexturedModalRect(this.x + 41, this.y + 16, 72, 85, 9, 11);
        }
        
        if (this.italic) {
			this.parent.drawTexturedModalRect(this.x + 51, this.y + 16, 72, 85, 9, 11);
        }
        
        if (this.strikethrough) {
			this.parent.drawTexturedModalRect(this.x + 41, this.y + 28, 72, 85, 9, 11);
        }
        
        if (this.underline) {
			this.parent.drawTexturedModalRect(this.x + 51, this.y + 28, 72, 85, 9, 11);
        }
    }
